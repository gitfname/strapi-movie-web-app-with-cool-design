...
export default function SeriesCard_2({title, date, desc, width=0, height=0, img={width:0, height:0, src:""}, pageLink, iconPos="tr", episodesCount=1}) {
    ...
    return (
        <div className="w-full h-full rounded-lg relative overflow-hidden">
            ...
            <div className="absolute z-10 top-0 left-0 w-full h-full movieCard2_darkLayer p-4 lg:p-5 flex flex-col justify-between">
                ...
                <p className="text-white/50 text-xs !text-[11px] font-light font-[Lexend] mt-[3px]">{date.year}</p>
                ...
                <div>
                    ...
                    <p className="text-white/50 text-xs !text-[11px] font-light font-[Lexend] mt-[3px]">{episodesCount} episodes</p>
                </div>
